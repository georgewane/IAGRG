...
<header class="resources-header">
  <div class="container">
    <h1>Quick Resources</h1>
    <p>
      A curated gateway to classic reviews, online notes, research databases, and trusted reference resources in general relativity, gravitation, astrophysics, and cosmology.
    </p>
  </div>
</header>
...
{% assign categorized_resources = site.data.quick-resources | group_by: "category" %}
    ...
    <div class="resource-grid">
      ...
      <a href="{{ resource.url }}"
        ...
        <p class="resource-curator">
          Maintained by <strong>{{ resource.curator }}</strong>
        </p>
